              ...
              >
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  <div className="relative shrink-0">
                    <img src={chat.avatar || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=150'} alt={chat.name} className="w-11 h-11 rounded-full object-cover border border-slate-200" />
                    {chat.unread > 0 && (
