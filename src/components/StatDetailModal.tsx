            ...
            {activeStat === 'visitors' &&
              visitors.map((v) => (
                <div key={v.id} className="pt-3 first:pt-0 flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      <img src={v.avatar || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=120'} alt={v.name} className="w-12 h-12 rounded-full object-cover ring-2 ring-amber-400/30" />
                      {v.isVIP && (
            ...
            {activeStat === 'friends' &&
              friends.map((f) => (
                <div key={f.id} className="pt-3 first:pt-0 flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      <img src={f.avatar || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=120'} alt={f.name} className="w-12 h-12 rounded-full object-cover" />
                      <span
            ...
            {activeStat === 'likes' &&
              likes.map((l) => (
                <div key={l.id} className="pt-3 first:pt-0 flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <img src={l.userAvatar || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=120'} alt={l.userName} className="w-11 h-11 rounded-full object-cover" />
                    <div>
                  ...
                  {l.giftIcon && (
                    <div className="w-10 h-10 rounded-xl bg-amber-500/10 flex items-center justify-center text-xl shadow-xs overflow-hidden">
            ...
            {activeStat === 'followers' &&
              followers.map((fl) => (
                <div key={fl.id} className="pt-3 first:pt-0 flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <img src={fl.avatar || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=120'} alt={fl.name} className="w-12 h-12 rounded-full object-cover" />
                    <div>
                      <div className="flex items-center gap-2">
