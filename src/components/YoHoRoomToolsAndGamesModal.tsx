...
interface YoHoRoomToolsAndGamesModalProps {
  isOpen: boolean;
  onClose: () => void;
  roomId?: string;
  roomTitle?: string;
...
export const YoHoRoomToolsAndGamesModal: React.FC<YoHoRoomToolsAndGamesModalProps> = ({
  isOpen,
  onClose,
  roomId = '884920',
  ...
  return (
    <AnimatePresence>
      <div
        className="fixed inset-0 z-50 bg-black/65 backdrop-blur-xs flex items-end justify-center pointer-events-auto select-none cursor-default"
        onClick={onClose}
      >
        <motion.div
          initial={{ y: '100%' }}
        ...
        >
          ...
          <div className="overflow-y-auto px-5 pt-2 pb-6 space-y-6 custom-scrollbar">
            {/* ========================================================================= */}
            {/* SECTION 1: الألعاب التفاعلية (Interactive Games - 8 Games in 4x2 Grid)   */}
            {/* ========================================================================= */}
            <div className="space-y-3">
              ...
              {/* 4-Columns Grid (RTL: 1. Ludo, 2. صيد, 3. الدومينو, 4. الفائز الرهيب / 5. ONO, 6. مشاهدة فيديو, 7. مقهى الكاذب, 8. الكاروم) */}
              <div className="grid grid-cols-4 gap-3 pt-1">
                ...
                {/* 6. مشاهدة فيديو (Watch Video / Cinema Mode) */}
                <button
                  type="button"
                  onClick={() => {
                    onClose();
            ...
            {/* ========================================================================= */}
            {/* SECTION 2: الأدوات الأساسية (Essential Tools - Matching Reference)       */}
            {/* ========================================================================= */}
            <div className="space-y-3 pt-2">
              ...
              <div className="grid grid-cols-4 gap-3 pt-1">
                ...
                {/* 6. أدوات تفاعلية (Interactive Tools) */}
                <button
                  type="button"
