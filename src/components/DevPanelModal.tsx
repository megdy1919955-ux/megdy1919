      ...
      <div className="relative w-full max-w-lg bg-slate-950 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden text-white animate-in fade-in zoom-in duration-200 max-h-[90vh] flex flex-col">
        ...
        <div className="p-5 overflow-y-auto space-y-4 flex-1 custom-scrollbar">
          ...
          <div className="space-y-3">
            ...
            {/* Gift CMS Quick Management Card */}
            <div className="bg-gradient-to-r from-cyan-950/40 via-slate-900 to-indigo-950/40 border border-cyan-500/30 rounded-2xl p-4 space-y-3 shadow-md">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h6 className="text-xs font-bold text-white">نظام إدارة الهدايا والتعديل المباشر (Gift CMS)</h6>
                    <span className="text-[10px] text-slate-400">تعديل ملفات الحركة، الأسماء، الأسعار والتأثيرات الصوتية</span>
                  </div>
                </div>
                <span className="text-[10px] font-bold bg-cyan-500/20 text-cyan-300 px-2 py-0.5 rounded-full border border-cyan-400/40">
                  متصل لحظياً
                </span>
              </div>

              <div className="p-2.5 bg-slate-950/80 rounded-xl border border-white/5 text-xs space-y-2">
                <div className="flex items-center justify-between text-slate-300 text-[11px]">
                  <span>صلاحية العرض داخل المتجر:</span>
                  <span className="font-bold text-cyan-300 bg-cyan-950 px-2 py-0.5 rounded-md border border-cyan-800">
                    Developer / Designer / Admin
                  </span>
                </div>
                <p className="text-[10px] text-slate-400 leading-relaxed">
                  تظهر أيقونة سهم التعديل (تحميل/تعديل) وزر الإضافة (+) تلقائياً داخل قائمة الهدايا في أسفل شاشة الغرفة الصوتية لأصحاب الصلاحيات فقط.
                </p>
              </div>
            </div>
