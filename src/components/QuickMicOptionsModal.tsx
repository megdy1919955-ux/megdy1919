        ...
        >
          ...
          >
            ...
            <div className="p-4 space-y-3">
              <div className={`grid ${hasMicControl ? 'grid-cols-4' : 'grid-cols-3'} gap-2.5 w-full`}>
                {/* 1. كتم المايك / فتح المايك (متاح فقط لمالك الغرفة والمشرفين الإداريين) */}
                {hasMicControl && (
                  <button
                    onClick={() => {
                      onToggleMute?.();
                    ...
                    title={isMuted ? 'فتح المايك' : 'كتم المايك'}
                  >
